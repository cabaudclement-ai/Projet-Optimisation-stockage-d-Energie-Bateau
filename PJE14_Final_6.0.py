...
stock_H2_kJ = 138890            #réel positif (kJ)
stock_Batterie_kJ = 83335       #réel positif (kJ)

stock_H2 = stock_H2_kJ*3600                 #réel positif (J)
stock_Batterie = stock_Batterie_kJ*3600     #réel positif (J)
...
def empreinte_carbone_H2 (nb_de_piles_utilisees, E_Pile_H2, emprunte):      #Emprunte en kg de CO2/t d'H2 produit
    ...
    return nb_de_piles_utilisees*emprunte*mHydrogenekWh/1000
...
emprunte_carbonne_H2 = empreinte_carbone_H2(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2)[14], Sequence(nb_stop_batterie, V_bateau, Distance_trajet)[13][-1], 26)
print("empreinte carbonne de l'hydrogene ", emprunte_carbonne_H2, "kg")
