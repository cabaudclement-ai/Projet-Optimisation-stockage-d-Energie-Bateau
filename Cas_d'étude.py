...
Pcharge_batterie = 400000          #réel positif (W)
Pcharge_H2 = 200000                #réel positif (W)
...
acceleration_mot = 0.2            #réel positif (m/s²)

stock_H2_kWh = 40*2            #réel positif (kWh)
stock_Batterie_kWh = 51.2*2       #réel positif (kWh)
...
def Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie):
    ...
    t_empreinte_carbone_H2 = empreinte_carbone_H2(t_recharge_H2, Sequence(nb_stop_batterie, V_bateau, Distance_trajet)[13][-1], 26)
    t_empreinte_carbone_Batt = empreinte_carbone_batterie(t_recharge_batterie, Sequence(nb_stop_batterie, V_bateau, Distance_trajet)[14][-1], 0.05, 2000, 1000)
    ...
    t_empreinte_carbone_essence = empreinte_carbone_diesel (t_nombre_de_trajet*(Sequence(nb_stop_batterie, V_bateau, Distance_trajet)[15]+Sequence(nb_stop_batterie, V_bateau, Distance_trajet)[16]), 0.270/3600000)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[1])
plt.title("Position")
plt.xlabel("t (s)")
plt.ylabel("X (m)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[2])
plt.title("Vitesse")
plt.xlabel("t (s)")
plt.ylabel("V (m/s)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[3])
plt.title("Accélération")
plt.xlabel("t (s)")
plt.ylabel("A (m/s²)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[4])
plt.title("Puissance mécanique")
plt.xlabel("t (s)")
plt.ylabel("P (W)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[5])
plt.title("Puissance électrique")
plt.xlabel("t (s)")
plt.ylabel("P (W)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[6])
plt.title("Puissance H2")
plt.xlabel("t (s)")
plt.ylabel("P (W)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[7])
plt.title("Puissance Batterie")
plt.xlabel("t (s)")
plt.ylabel("P (W)")
plt.grid(True)
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[8])
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[9])
...
plt.figure()
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[12])
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[13])
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[10])
plt.plot(Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[0],Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[11])
...
print('Nombre de recharges de piles H2 =', Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[14])
print('Nombre de recharges de batteries =', Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[15])
print('Nombre de trajets =', Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[16])
...
Nb_de_RechargementH2, Nb_de_RechargementBatterie = [Timeline(p[-1], nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[14]], [Timeline(p[-1], nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[15]]
Empreinte_Carbone = [Timeline(p[-1], nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[19]]
...
print("empreinte carbone de l'hydrogene ", Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[17], "kg")
print("empreinte carbone de la batterie ", Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[18], "kg")
print("empreinte carbone totale sur une journée ", Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[19], "kg")
print("empreinte carbone moteur diesel ", Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[20], "kg")
print("emission carbone économisée", Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[20] - Timeline(pourcentage_H2, nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[19], "kg")


for i in range(nb_de_p):
    Nb_de_RechargementH2.append(Timeline(p[-1], nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[14])
    Nb_de_RechargementBatterie.append(Timeline(p[-1], nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[15])
    Empreinte_Carbone.append(Timeline(p[-1], nb_stop_batterie, nb_stopH2, stock_H2, stock_Batterie)[19])
...
#empreinte_carbone_Hydrogene = empreinte_carbone_H2(3, E_Pile_H2, 3)
####################################################################################################################################
#Sorties
####################################################################################################################################
