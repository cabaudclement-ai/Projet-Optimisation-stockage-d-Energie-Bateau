...
stock_H2 = 500000000             #réel positif (J)
...
def empreinte_carbone_H2 (Pile):
    return Pile[1]*Pile[0]

def empreinte_carbone_batterie(nb,CO2):
    return nb*CO2
...
if __name__=='__main__':
    ...
    def Timeline(nb_stop_batterie, nb_stopH2):
        ...
        return t_T, t_X, t_V, t_A, t_Puissance_mec_Bateau, t_Puissance_elec_Bateau, t_Puissance_H2, t_Puissance_Batterie, t_Liste_E_H2, t_Liste_E_Batterie, t_Limite_H2, t_Limite_Batterie, t_Liste_stock_H2, t_Liste_stock_Batterie, t_recharge_H2, t_recharge_batterie, t_nombre_de_trajet
 
    
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[1])
    plt.title("Position")
    plt.xlabel("t (s)")
    plt.ylabel("X (m)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[2])
    plt.title("Vitesse")
    plt.xlabel("t (s)")
    plt.ylabel("V (m/s)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[3])
    plt.title("Accélération")
    plt.xlabel("t (s)")
    plt.ylabel("A (m/s²)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[4])
    plt.title("Puissance mécanique")
    plt.xlabel("t (s)")
    plt.ylabel("P (W)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[5])
    plt.title("Puissance électrique")
    plt.xlabel("t (s)")
    plt.ylabel("P (W)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[6])
    plt.title("Puissance H2")
    plt.xlabel("t (s)")
    plt.ylabel("P (W)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[7])
    plt.title("Puissance Batterie")
    plt.xlabel("t (s)")
    plt.ylabel("P (W)")
    plt.grid(True)
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[8])
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[9])
    ...
    plt.figure()
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[12])
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[13])
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[10])
    plt.plot(Timeline(nb_stop_batterie, nb_stopH2)[0],Timeline(nb_stop_batterie, nb_stopH2)[11])
    ...
    print('Nombre de recharges de piles H2 =', Timeline(nb_stop_batterie, nb_stopH2)[14])
    print('Nombre de recharges de batteries =', Timeline(nb_stop_batterie, nb_stopH2)[15])
    print('Nombre de trajets =', Timeline(nb_stop_batterie, nb_stopH2)[16])
...
### La séquence est une fonction, la suite va consister à transformere la timeline en fonction
